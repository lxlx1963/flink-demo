...
/**
 * FaceDatAgeRangeTypeInformationJob
 * <p>
 * 年龄段维度统计人数、人次
 *
 * @author dxy
 ...
 */
public class FaceDatAgeRangeTypeInformationJob {
	/**
	 * 日志
	 */
	private static Logger logger = LoggerFactory.getLogger(FaceDatAgeRangeTypeInformationJob.class);
...
//			String password = "CS<ty$!XC0TY";
			...
			DataSet<Tuple3<String, Integer, Integer>> dateSet = faceDataMap.groupBy("ageRange")
					.reduceGroup((GroupReduceFunction<FaceData, Tuple3<String, Integer, Integer>>) (in, out) -> {
						...
						out.collect(new Tuple3<>(key, count, visitorIdSet.size()));
